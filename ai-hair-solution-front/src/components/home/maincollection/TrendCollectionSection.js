...
// 슬라이더 속도 조정 및 더 많은 이미지 표시
const SliderTrack = styled(Box)(({ theme, animate }) => ({
    display: 'flex',
    width: 'fit-content',
    animation: animate ? `${infiniteSlide} 35s linear infinite` : 'none', // 슬라이더 속도 감소
}));
...
export default TrendCollectionSection;